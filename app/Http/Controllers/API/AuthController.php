...
class AuthController extends ApiController {
    ...
    public function register(Request $request) {
        ...
        $rules = ['username' => 'required', 'first_name' => 'required', 'last_name' => 'required', 'email' => 'required|email|unique:users', 'password' => 'required', 'image' => 'required', 'field_to_play' => 'required', 'field_to_play_id' => '', 'video_stream' => 'required', 'video_stream_id' => ''];

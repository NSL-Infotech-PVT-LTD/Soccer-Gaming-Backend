...
class TournamentFixtureReport extends Model {
     ...
     * @var array
     */
    protected $fillable = ['tournament_id', 'fixture_id', 'player_id_1', 'player_id_1_team_id', 'player_id_1_score', 'player_id_2', 'player_id_2_team_id', 'player_id_2_score', 'stage', 'created_by', 'updated_by','status'];

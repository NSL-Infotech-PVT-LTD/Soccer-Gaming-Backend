...
//            dd($friends);
        ...
        if($request->status == 'accepted'):
            parent::pushNotifications(['title' => '', 'body' => 'Your Friend Request has been accepted', 'data' => ['target_id' => \Auth::id(), 'target_model' => 'UserFriend', 'data_type' => 'FriendRequest']], $request->friend_id, TRUE);
        endif;

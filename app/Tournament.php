...
class Tournament extends Model {
    ...
    public function fixtures() {        
        return $this->hasMany('\App\TournamentFixture', 'tournament_id', 'id')->select('tournament_id', 'player_id_1', 'player_id_1_team_id', 'player_id_1_score', 'player_id_2', 'player_id_2_team_id', 'player_id_2_score');
    }

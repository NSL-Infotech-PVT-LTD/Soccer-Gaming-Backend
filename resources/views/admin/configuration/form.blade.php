<div class="form-group{{ $errors->has('about_us_customer') ? 'has-error' : ''}}">
    {!! Form::label('about_us_customer', 'About Us customer', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('terms_and_conditions_customer') ? 'has-error' : ''}}">
    {!! Form::label('terms_and_conditions_customer', 'Terms And Conditions Customer', ['class' => 'control-label']) !!}
...
<div class="form-group{{ $errors->has('private_policy_customer') ? 'has-error' : ''}}">
    {!! Form::label('private_policy_customer', 'private Policy Customer', ['class' => 'control-label']) !!}

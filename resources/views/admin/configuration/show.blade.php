...
<!--                                    <tr><th> About Us </th><td> {{ $configuration->about_us_customer }} </td></tr><tr><th> Terms And Conditions Organiser </th><td> {{ $configuration->terms_and_conditions_organiser }} </td></tr><tr><th> Terms And Conditions Coach </th><td> {{ $configuration->terms_and_conditions_coach }} </td></tr>-->
                                </tbody>
                            </table>
                        </div>
